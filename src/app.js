...
let evaluation = document.querySelector('.card-container-evaluation'); // evalutation div //
let thankyou = document.querySelector('.card-container-thankyou'); // thank you div //
